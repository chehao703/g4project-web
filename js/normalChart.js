function plotNormal(stockid) {
  ...
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_cash_div);
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_stock_div);
  ...
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_sales);
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_costs);
  ...
  $.getJSON("./dataset/個股資訊/個股_一般.json", addData_income);
  $.getJSON("./dataset/個股資訊/個股_一般.json", addData_eps);
  ...
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_assets);
  $.getJSON("./dataset/個股資訊/個股_一般.json", adddata_liabilities);
  ...
  $.getJSON("./dataset/個股資訊/個股_一般.json", addData_net_asset);
  $.getJSON("./dataset/個股資訊/個股_一般.json", addData_bvps);
