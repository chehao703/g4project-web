function plotBank(stockid) {
  ...
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_cash_div);
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_stock_div);
  ...
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_interest_income);
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_other_income);
  ...
  $.getJSON("./dataset/個股資訊/個股_銀行.json", addData_income);
  $.getJSON("./dataset/個股資訊/個股_銀行.json", addData_eps);
  ...
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_assets);
  $.getJSON("./dataset/個股資訊/個股_銀行.json", adddata_liabilities);
  ...
  $.getJSON("./dataset/個股資訊/個股_銀行.json", addData_net_asset);
  $.getJSON("./dataset/個股資訊/個股_銀行.json", addData_bvps);
